...
<body>
  ...
  <div id="completed" class="panel active">
    ...
    <p>List of completed rooms will appear here.</p>
  </div>

  <div id="certificates" class="panel">
    <h2>Certificates</h2>
    <p>All earned certificates will appear here.</p>
  </div>

  <div id="skills" class="panel">
    <h2>Skills Matrix</h2>
    <p>Skills progress will appear here.</p>
  </div>
